      ...
      {items.map((item, index) => (
        ...
        >
          ...
          >
            ...
            {/* Timeline Content */}
            <div
              className={`card lg:w-[calc(50%-2rem)] animate-fade-in-up ${
            ...
            >
              ...
              <h3 className="text-xl font-bold text-portfolio-lightestSlate">
                {item.title}
              </h3>
              <h4 className="text-lg text-portfolio-cyan mb-1">
                {item.organization}
              </h4>
              <p className="text-sm text-portfolio-slate mb-4">
                {item.location}
              </p>
