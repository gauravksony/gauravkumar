      ...
      <section className="py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            {/* Contact Information */}
            <div>
              <h2 className="text-2xl font-bold text-portfolio-lightestSlate mb-6">Get In Touch</h2>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-portfolio-lightestSlate mb-1">Email</h3>
                    <a 
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-portfolio-lightestSlate mb-1">Phone</h3>
                    <a 
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-portfolio-lightestSlate mb-1">Location</h3>
                    <p className="text-portfolio-slate">{personalInfo.location}</p>
                  </div>
                </div>
              </div>
              ...
              {/* Social Links */}
              <div>
                <h3 className="text-lg font-medium text-portfolio-lightestSlate mb-4">Connect With Me</h3>
